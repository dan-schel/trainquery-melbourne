import type { StopGtfsIdsConfig } from "../../gtfs/corequery-gtfs/config/ids.js";
...
export const stopGtfsIds: StopGtfsIdsConfig = {
  ...
  [stop.HAWKSBURN]: {
    suburban: {
      ...
      platforms: {
        ...
        [position.PLATFORM_3]: ["14269"],
        [position.PLATFORM_4]: ["14270"],
      },
      replacementBus: ["26188"],
    },
  },
  ...
  [stop.SOUTHERN_CROSS]: {
    suburban: {
      ...
      general: ["20043"],
      platforms: {
        [position.PLATFORM_1]: ["26524"],
        [position.PLATFORM_2]: ["22181"],
        [position.PLATFORM_3]: ["22182"],
        [position.PLATFORM_4]: ["22183"],
        [position.PLATFORM_5]: ["22184"],
        [position.PLATFORM_6]: ["22185"],
        [position.PLATFORM_7]: ["22186"],
        ...
        [position.PLATFORM_15]: ["26525"],
        [position.PLATFORM_16]: ["26526"],
      },
